 ...
 */
  #define MCG_PDD_SetAutoTrimTarget(PeripheralBase, Target) ( \
      MCG_SC_REG(PeripheralBase) = \
       (uint8_t)(( \
        (uint8_t)(MCG_SC_REG(PeripheralBase) & (uint8_t)(~(uint8_t)MCG_SC_ATMS_MASK))) | ( \
        (uint8_t)(Target))) \
    )
#else /* (defined(MCU_MKW21D5)) || (defined(MCU_MKW21D5WS)) || (defined(MCU_MKW22D5)) || (defined(MCU_MKW22D5WS)) || (defined(MCU_MKW24D5)) || (defined(MCU_MKW24D5WS)) */
/**
 ...
 */
  #define MCG_PDD_EnableFllFilterPreserve(PeripheralBase, State) ( \
      MCG_SC_REG(PeripheralBase) = \
       (uint8_t)(( \
        (uint8_t)(MCG_SC_REG(PeripheralBase) & (uint8_t)(~(uint8_t)MCG_SC_FLTPRSRV_MASK))) | ( \
 ...
 */
  #define MCG_PDD_SetFastInternalDivider(PeripheralBase, Divider) ( \
      MCG_SC_REG(PeripheralBase) = \
       (uint8_t)(( \
        (uint8_t)(MCG_SC_REG(PeripheralBase) & (uint8_t)(~(uint8_t)MCG_SC_FCRDIV_MASK))) | ( \
        (uint8_t)(Divider))) \
    )
#else /* (defined(MCU_MKW21D5)) || (defined(MCU_MKW21D5WS)) || (defined(MCU_MKW22D5)) || (defined(MCU_MKW22D5WS)) || (defined(MCU_MKW24D5)) || (defined(MCU_MKW24D5WS)) */
/**
