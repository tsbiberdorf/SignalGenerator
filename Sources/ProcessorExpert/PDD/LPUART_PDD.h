...
/* ----------------------------------------------------------------------------
  ...
  #error LPUART PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MK65F18) /* LPUART0 */ && \
      !defined(MCU_MK65F18WS) /* LPUART0 */ && \
      !defined(MCU_MK66F18) /* LPUART0 */ && \
      !defined(MCU_MKL03Z4) /* LPUART0 */ && \
...
/* Clock sources */
  #define LPUART_PDD_DISABLE_CLOCK           0U    /**< Disable the clock. */
  #define LPUART_PDD_FAST_INTERNAL_REF_CLOCK 0x1U  /**< Fast internal reference clock. */
  #define LPUART_PDD_EXTERNAL_REF_CLOCK      0x2U  /**< External reference clock. */
  #define LPUART_PDD_SLOW_INTERNAL_REF_CLOCK 0x3U  /**< Slow internal reference clock. */
...
/* Clock sources */
  #define LPUART_PDD_DISABLE_CLOCK      0U         /**< Disable the clock. */
  #define LPUART_PDD_PLL_FLL_CLOCK      0x1U       /**< MCG PLL or FLL clock. */
  #define LPUART_PDD_EXTERNAL_REF_CLOCK 0x2U       /**< External reference clock. */
  #define LPUART_PDD_INTERNAL_REF_CLOCK 0x3U       /**< Internal reference clock. */
...
#define LPUART_PDD_DisableInterrupt(PeripheralBase, Mask) ( \
    LPUART_CTRL_REG(PeripheralBase) &= \
     (uint32_t)(~(uint32_t)((uint32_t)((uint32_t)(Mask) & 0xFFU) << 20U)) \
  )
...
#define LPUART_PDD_GetChar9To10thBit(PeripheralBase) ( \
    (uint16_t)(( \
     (uint16_t)(( \
      (uint16_t)(( \
       (uint32_t)(LPUART_DATA_REG(PeripheralBase) & LPUART_DATA_R9T9_MASK)) >> ( \
 ...
 *        FAST_INTERNAL_REF_CLOCK, EXTERNAL_REF_CLOCK, SLOW_INTERNAL_REF_CLOCK. Use constants from
 *        group "Clock sources". This parameter is 32 bits wide.
 * @return Returns a value of void type.
 * @par Example:
 *      @code
 *      LPUART_PDD_SetClockSource(<peripheral>_BASE_PTR,
 *      LPUART_PDD_DISABLE_CLOCK);
 *      @endcode
 */
  #define LPUART_PDD_SetClockSource(PeripheralBase, Source) ( \
      SIM_SOPT2_REG(SIM_BASE_PTR) = \
       (( \
        (uint32_t)(SIM_SOPT2_REG(SIM_BASE_PTR) & (uint32_t)(~(uint32_t)SIM_SOPT2_LPUART0SRC_MASK))) | ( \
        (uint32_t)((uint32_t)(Source) << SIM_SOPT2_LPUART0SRC_SHIFT))) \
    )
#else /* (defined(MCU_MK22F12810)) || (defined(MCU_MK22F25612)) || (defined(MCU_MK22F51212)) || (defined(MCU_MK65F18)) || (defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKV31F12810)) || (defined(MCU_MKV31F25612)) || (defined(MCU_MKV31F51212)) */
/**
 * @brief Selects the clock source (in the SIM module).
