...
/* ----------------------------------------------------------------------------
  ...
  #error TSI PDD library: No derivative is active. Place proper #include with PDD memory map before including PDD library.
      ...
      !defined(MCU_MK65F18WS) /* TSI0 */ && \
      !defined(MCU_MK66F18) /* TSI0 */ && \
...
#if ((defined(MCU_MK65F18WS)) || (defined(MCU_MK66F18)) || (defined(MCU_MKL05Z4)) || (defined(MCU_MKL15Z4)) || (defined(MCU_MKL16Z4)) || (defined(MCU_MKL25Z4)) || (defined(MCU_MKL26Z4)) || (defined(MCU_MKL36Z4)) || (defined(MCU_MKL46Z4)) || (defined(MCU_MKW01Z4)))
/**
 ...
 * @par Example:
 *      @code
 *      TSI_PDD_EnableDevice(<peripheral>_BASE_PTR, 1);
 *      @endcode
 */
