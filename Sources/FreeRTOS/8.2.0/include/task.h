...
{
	BaseType_t xOverflowCount;	/**< xOverflowCount */
	TickType_t xTimeOnEntering;	/**< xTimeOnEntering */
} TimeOut_t;
...
{
	void *pvBaseAddress; 		/**< pvBaseAddress */
	uint32_t ulLengthInBytes;	/**< ulLengthInBytes */
	uint32_t ulParameters;		/**< ulParameters */
} MemoryRegion_t;
